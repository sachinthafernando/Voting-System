...
const SideNavbar = ({auth: { isAuthenticated, loading }, logout, toggle})=> {
  // debugger;
...
const GoBackButton = withRouter(
  ({ history }) => (
    <SubButton onClick={history.goBack} to='' primary='true'><IoChevronBackCircleOutline/><span>BACK</span></SubButton>
  )
);

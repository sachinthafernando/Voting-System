...
export default class Scanner extends Component {
    ...
    checkPerson(e) {
        debugger;
        e.preventDefault();
        axios.get('http://localhost:5000/api/person/'+this.state.barcode)
        .then(response => {
            debugger;
            this.setState({
            ...
            axios.get('http://localhost:5000/api/GNDivision/'+response.data.gnd)
            .then(resp => {debugger;
                this.setState({
    ...
    allowVote(e){
        ...
        debugger;
        axios.put('http://localhost:5000/api/Rank4Admin/State/'+this.state.PollingCenter.id, obj)
        .then(res => {

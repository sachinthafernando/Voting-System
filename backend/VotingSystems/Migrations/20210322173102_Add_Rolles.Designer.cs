...
namespace VotingSystems.Migrations
{
    ...
    [Migration("20210322173102_Add_Rolles")]
    partial class Add_Rolles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VotingSystems.Models.PollingCenter", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("VotingSystems.Models.PollingCenter", b =>
                {
                    b.HasOne("VotingSystems.Models.Admin", "Admin")
                        .WithOne("Center")
                        .HasForeignKey("VotingSystems.Models.PollingCenter", "Admin_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
